/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b9f3ba3792f9c4c66198e216d0a5b79)
// Runtime types generated with workerd@1.20250829.0 2025-09-03 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		NODE_ENV: "production" | "development";
		SESSION_SECRET: "your-session-secret-change-this" | "dev-session-secret";
		DATABASE_URL: "your-external-postgres-url-if-using" | "postgresql://localhost:5432/ptc_election";
		ENCRYPTION_KEY: "your-32-char-encryption-key-here" | "dev-encryption-key-32chars-long";
		FILES: R2Bucket;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "SESSION_SECRET" | "DATABASE_URL" | "ENCRYPTION_KEY">> {}
}
